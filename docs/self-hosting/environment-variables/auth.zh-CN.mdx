...
- 默认值：`-`
- 示例： `pk_test_YOUR_PUBLISHABLE_KEY_HERE` （测试环境） / `pk_live_YOUR_PUBLISHABLE_KEY_HERE` （生产环境）
...
- 默认值：`-`
- 示例： `sk_test_YOUR_SECRET_KEY_HERE` （测试环境） / `sk_live_YOUR_SECRET_KEY_HERE`（生产环境）
